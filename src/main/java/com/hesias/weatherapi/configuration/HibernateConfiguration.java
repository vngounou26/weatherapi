...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.hesias.weatherapi.model" });
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.database-platform", environment.getRequiredProperty("spring.jpa.database-platform"));
        return properties;
    }
